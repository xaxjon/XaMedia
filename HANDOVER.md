...
- **Model availability on this key** (probed 2026-09-21): ONLY `gemini-3.1-flash-live-preview` works end-to-end (setup + tools + audio + turnComplete). `gemini-3.8-live` eats post-tool turns; 2.5-flash-live-preview, 2.5 native-audio variants, 3.7/3.8-flash-live all reject the setup (close 1000).
